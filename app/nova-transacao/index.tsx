            ...
            <View style={styles.formSection}>
                    ...
                    <View style={styles.inputGroup}>
                      ...
                      {cards.length > 0 ? (
                        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.cardSelectorScroll}>
                          ...
                          <TouchableOpacity style={styles.addCardMiniButton} onPress={() => router.push('/novo-cartao/index' as any)}><Ionicons name="add" size={20} color={theme.primary} /><Text style={styles.addCardMiniText}>Novo</Text></TouchableOpacity>
                        </ScrollView>
                      ) : (
                        <TouchableOpacity style={styles.noCardsContainer} onPress={() => router.push('/novo-cartao/index' as any)}><Ionicons name="card-outline" size={24} color={theme.textMuted} /><Text style={styles.noCardsText}>Toque para adicionar um cartão.</Text></TouchableOpacity>
                      )}
                    </View>
                  )}
              ...
              <View style={styles.inputGroup}>
                <View style={styles.sectionHeader}>
                  ...
                  <TouchableOpacity style={styles.addCategoryLink} onPress={() => router.push('/categorias/index' as any)}>
                ...
                {currentCategories.length > 0 ? (
                  ...
                  <TouchableOpacity style={styles.noCategoriesContainer} onPress={() => router.push('/categorias/index' as any)}><Ionicons name="pricetag-outline" size={24} color={theme.textMuted} /><Text style={styles.noCategoriesText}>Toque para criar uma categoria.</Text></TouchableOpacity>
                )}
              </View>
            </View>
          </ScrollView>
