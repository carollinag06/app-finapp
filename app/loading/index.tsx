...
export default function LoadingSetup() {
  ...
  useEffect(() => {
    ...
    // 3. Tempo simulado de carregamento (3 segundos) antes de navegar para a Home
    const timer = setTimeout(() => {
      // IMPORTANTE: Aqui você define para onde o app vai APÓS o loading!
      // Olhando sua imagem anterior, vi que você tem uma pasta (tabs).
      // Geralmente a tela inicial fica em '/(tabs)' ou '/(tabs)/agendamento'
      // Ajuste o caminho abaixo para a rota principal do seu app:
      router.replace('/(tabs)');
    }, 3000);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.titleText}>Personalizando o app para você...</Text>
